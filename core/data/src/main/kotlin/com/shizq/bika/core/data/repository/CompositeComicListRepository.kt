...
class CompositeComicListRepository @Inject constructor(
    ...
    fun getPagingFlowByCategories(category: String?): Flow<PagingData<ComicResource>> =
    ...
    private fun shouldHideCategory(category: String?): Boolean {
        return when (category) {
            "recommend", "random", "recently", "favourite" -> false
            else -> true
        }
    }
}
